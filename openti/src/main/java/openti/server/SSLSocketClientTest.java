...
public class SSLSocketClientTest extends JFrame {

	public static void main(String[] args) {
		new SSLSocketClientTest().setVisible(true);
	}
	...
	protected void connect() throws UnknownHostException, IOException {
		...
		cSocket = (SSLSocket) sslSocketFactory.createSocket(host.getText(), 8083);
