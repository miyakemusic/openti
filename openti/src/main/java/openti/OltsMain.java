...
public class OltsMain extends AbstractIndependentMain {
	public static void main(String[] args) {
		new OltsMain(args[0], args[1], args[2], args[3], args[4], args[5].equals("true"));
	}
	...
	public OltsMain(String host, String port, String userid, String application, String deviceName, boolean headless) {
